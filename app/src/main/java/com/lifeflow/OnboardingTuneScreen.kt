...
internal fun OnboardingTuneScreen(
    lastAction: String = "Onboarding tune preview active",
    onContinue: () -> Unit = {},
    onLeaveAsIs: () -> Unit = {},
    ...
    ScreenContainer(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Fine-tune with a light touch",
                ...
                Text(
                    text = "Small adjustments should feel calm, reversible, and easy to understand — never like a crowded control panel.",
                ...
                LifeFlowSectionPanel(title = "Small changes, clear effect") {
                    Text(
                        text = "Tone, rhythm, and presence can be adjusted gently. You should feel what changed without having to dig through settings.",
                ...
                LifeFlowSectionPanel(title = "Calm by default") {
                    Text(
                        text = "LifeFlow should already feel good before tuning. Controls are there to refine your space, not to rescue a noisy design.",
                        style = lifeFlowCardSummaryStyle(),
                        color = TuneTextTertiary
                    )
                }
...
@Composable
private fun TuneScreenBackground(
