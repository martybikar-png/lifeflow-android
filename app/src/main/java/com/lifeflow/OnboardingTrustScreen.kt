...
internal fun OnboardingTrustScreen(
    lastAction: String = "Onboarding trust preview active",
    onContinue: () -> Unit = {},
    ...
    ScreenContainer(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Your space stays quietly yours",
                ...
                Text(
                    text = "Private by default.\nYour reflections stay with you, under your control.",
                ...
                LifeFlowSectionPanel(title = "Private by default") {
                    Text(
                        text = "Nothing is shared by default. Your notes and signals stay in your space.",
                ...
                LifeFlowSectionPanel(title = "Under your control") {
                    Text(
                        text = "You decide what connects, what stays paused, and what remains yours.",
                        style = lifeFlowCardSummaryStyle(),
                        color = TrustTextTertiary
                    )
                }
...
@Composable
private fun TrustScreenBackground(
