...
internal fun OnboardingHomeScreen(
    lastAction: String = "Onboarding home preview active",
    onContinue: () -> Unit = {},
    onPause: () -> Unit = {},
    ...
    ScreenContainer(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "LifeFlow can stay calm and useful when the next step is simple, visible, and never louder than it needs to be.",
                ...
                LifeFlowSectionPanel(title = "One next step") {
                    Text(
                        text = "Home is there to offer one calm next move, not a wall of options. What matters most should feel easy to see, easy to trust, and useful without becoming crowded.",
